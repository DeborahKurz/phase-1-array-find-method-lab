...
//Try 2: Returns the keys, but it isn't a function
// let superbowlWin = record.find(isWin)
// console.log(superbowlWin)

// function isWin(search){
//     return search.result === "W"
// }

//Try 3: Returns the correct year, but does NOT return undefined.
// function superbowlWin(objectArgument){
//     let result = record.find(search => search.result === "W")
//     return result.year;
// };

// Try 4: Returns the correct year, but does NOT return undefined.
// function superbowlWin(objectArgument){
...
// Try 5: With TC help -> Passes all tests.
superbowlWin = (record) => {
